...
class _SignupState extends State<Signup> {
  ...
  registration() async {
    try {
      if (passwords != null) {
        UserCredential crendetials = await FirebaseAuth.instance
        ...
        await firebasehelper().adduserdetaile(addUserInfo,Id);
        await Sharedreferenceshelper().saveusername(namecontroller.text);
        await Sharedreferenceshelper().saveuseremail(emailcontroller.text);
        await Sharedreferenceshelper().saveuserid(Id);
        await Sharedreferenceshelper().saveuserwallet('0');
